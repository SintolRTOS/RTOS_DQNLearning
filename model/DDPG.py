# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 15:11:23 2019
...
print('init random seed sucessful!')

import logging #引入log日志模块
logging.basicConfig(level=logging.DEBUG,
                    format='%(asctime)s - %(filename)s[line:%(lineno)d] - %(levelname)s: %(message)s')  # logging.basicConfig函数对日志的输出格式及方式做相关配置 # 由于日志基本配置中级别设置为DEBUG，所以一下打印信息将会全部显示在控制台上

tfconfig = tf.ConfigProto()
tfconfig.gpu_options.allow_growth = False
session = tf.Session(config=tfconfig)
print('init tensorflow seession sucessful!')
...
class DDPG(object):
    ...
    def __init__(self,
        ...
        print('init Actor network sucessful!')
        ...
        print('init Critic network sucessful!')
        ...
        print('init parameters sucessful!')
        ...
        print('init soft_replace sucessful!')
